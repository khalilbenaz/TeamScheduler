...
namespace PlanningPresenceBlazor.Migrations
{
    ...
    [Migration("20250615005747_AddEmployeeHierarchy")]
    partial class AddEmployeeHierarchy
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EmployeeEmployee", b =>
                {
                    b.Property<int>("SubordonnesId")
                        .HasColumnType("INTEGER");

                    b.Property<int>("SuperieursId")
                        .HasColumnType("INTEGER");

                    b.HasKey("SubordonnesId", "SuperieursId");

                    b.HasIndex("SuperieursId");

                    b.ToTable("EmployeeHierarchy", (string)null);
                });
            ...
            modelBuilder.Entity("EmployeeEmployee", b =>
                {
                    b.HasOne("TeamScheduler.Core.Entities.Employee", null)
                        .WithMany()
                        .HasForeignKey("SubordonnesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TeamScheduler.Core.Entities.Employee", null)
                        .WithMany()
                        .HasForeignKey("SuperieursId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
